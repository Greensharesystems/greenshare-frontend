			...
			{isCreateView ? (
				<div className="mx-auto grid w-full max-w-7xl grid-cols-[auto_minmax(0,1fr)] gap-x-6 gap-y-4">
					...
					<div className="w-full max-w-4xl pt-2">
						<h1 className="text-base font-normal tracking-normal text-slate-950">Add Circularity Certificate</h1>
					</div>
				...
				<div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
					<h1 className="text-base font-normal tracking-normal text-slate-950">Circularity Certificates</h1>
					<p className="max-w-3xl text-sm leading-6 text-slate-600">
						Review and manage circularity certificate activity.
					</p>
